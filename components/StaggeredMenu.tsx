...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      className={`sm-scope z-999 pointer-events-none ${
        isFixed
              ...
              {items && items.length ? (
                items.map((it, idx) => (
                  ...
                  >
                    {it.isButton ? (
                      <a
                        className="sm-panel-item-button relative text-white font-bold text-[1.5rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-all duration-300 ease-out inline-block no-underline pr-[1.4em] py-3 px-6 rounded-lg"
                        href={it.link}
                        aria-label={it.ariaLabel}
                        data-index={idx + 1}
                        style={{
                          background: `linear-gradient(135deg, #B3005E, #00D9FF)`,
